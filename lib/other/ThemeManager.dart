...
class ThemeChanger with ChangeNotifier{
  ...
  static final List<ThemeData> themeDataDARK = <ThemeData>[
  ...
  static final List<ThemeData> themeDataLIGHT = <ThemeData>[
  ...
  ThemeData getThemeLIGHT() => _isDark==1?themeDataDARK[currentTheme]:themeDataLIGHT[currentTheme];
  ThemeData getThemeDARK() => _isDark==-1?themeDataLIGHT[currentTheme]:themeDataDARK[currentTheme];
